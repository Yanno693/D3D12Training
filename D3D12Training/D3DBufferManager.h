...
public:
	...
	void InitializeIndexBuffer(D3DIndexBuffer* a_pIndexBuffer, UINT const a_uiSizeInBytes, D3D12_RESOURCE_STATES const a_eDefaultState = D3D12_RESOURCE_STATE_COMMON);
