...
/*
void D3DVertexBuffer::Initialize(ID3D12Device* a_pDevice, unsigned int const a_uiSizeInBytes)
{
	m_pDevice = a_pDevice;
...
void D3DVertexBuffer::TransitionState(ID3D12GraphicsCommandList* a_commandList, D3D12_RESOURCE_STATES a_targetResourceState)
{
...
void D3DVertexBuffer::WriteData(void* a_pData, UINT a_uiSize, UINT a_uiDstOffset)
{
    D3D12_RANGE range;
    range.Begin = 0;
    range.End = 0;
...
void D3DVertexBuffer::SetDebugName(LPCWSTR a_sName)
{
